...
import { ColumnsImageText, getColumnsWidth } from "../Columns.utils";
import * as P from "./ColumnsImageText.parts";

export default function ColumnsTextImage({ source, leftColumnWidth = 50, withH1 = true }: ColumnsImageText) {
