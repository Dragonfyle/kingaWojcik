  ...
  return (
    <P.ItemWrapper>
      ...
      <P.DescriptionWrapper>
        ...
        <P.ItemDescription>
          Occaecat qui voluptate ipsum consectetur culpa. Est adipisicing non
          laborum nulla reprehenderit laborum pariatur anim voluptate. Dolor id
          ullamco eu eu cupidatat velit ea.
        </P.ItemDescription>
      </P.DescriptionWrapper>
    </P.ItemWrapper>
  );
